...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button create = view.findViewById(R.id.create_event);
        create.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dialog dialog;
                dialog = new Dialog(getContext());
                dialog.setContentView(R.layout.previewpreviewcreateorg);
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                Button yes_publish = dialog.findViewById(R.id.button_yes_publish);
                dialog.show();
                yes_publish.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String name = ((EditText) view.findViewById(R.id.eventnameinput)).getText().toString();
                        String description = ((EditText) view.findViewById(R.id.eventdescription)).getText().toString();
                        String hours = ((EditText) view.findViewById(R.id.eventhours)).getText().toString();
